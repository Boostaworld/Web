const ContactForm = () => {
  return (
    <section id="contact" className="section-shell space-y-4">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#16102a] via-[#0f0b1d] to-[#0a0816] p-8 shadow-[0_20px_60px_rgba(255,62,181,0.15)]">
        ...
        <form className="relative grid gap-4 md:grid-cols-2">
          ...
          <label className="flex flex-col gap-2">
            ...
            <input type="text" placeholder="#INV-00042" className="input-field" />
          </label>
          <label className="flex flex-col gap-2 md:col-span-2">
            <span className="text-sm text-slate-300">Message</span>
            <textarea rows="4" placeholder="What would you like to ask?" className="input-field" />
          </label>
